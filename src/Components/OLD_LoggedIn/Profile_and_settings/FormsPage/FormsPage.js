...
const default_terms = 'By accepting the terms and conditions you grant the receiver of this data full rights to share and distribute the data with people inside and outside their organization as they see fit.'
        ...
        <div className={classnames(container, small_container, center_container)}>
          <div className={inner_container}>
            <div className={error_box}>
              Input forms are only avalable for teams. Contact us for more information about how to upgrade your account.
            </div>          
          </div>
        </div>
      )
      ...
      <div className={classnames(container, small_container)}>
        <div className={inner_container}>
          ...
          <div className={section} >
            ...
            <div>
              Your form ID is: {form.id}
            </div>

            <Link to={`${publicSubmitForm}/${form.id}`} >
              View form
            </Link>
                        ...
                        setNewCustomField={newField => {
                          ...
                          mutate({
                            ...
                            optimisticResponse: {
                              ...
                              putForm: {
                                ...form,
                                customFields: variables.input.customFields.map(c => ({
                                  ...c,
                                  section: c.section || '',
                                  options: c.options || [],
                                    ...
                                    onClick={() => {
                                      ...
                                      mutate({
                                        ...
                                        optimisticResponse: {
                                          ...
                                          putForm: {
                                            ...form,
                                            hiddenFields: variables.input.hiddenFields
                                          }                                          
                                        }
                                      })
...
const ComposedComponent = () => {
  const Composed = adopt({
    ...
    teamQuery: ({ render }) => (
      <Query query={getTeam}>{render}</Query>
    ),
    formsQuery: ({ render }) => (
      <Query query={getForms}>{render}</Query>
    )
  });
