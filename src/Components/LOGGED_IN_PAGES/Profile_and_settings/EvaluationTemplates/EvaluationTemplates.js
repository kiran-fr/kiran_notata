              ...
              onSubmit={e => {
                ...
                mutate({
                  ...
                  update: (proxy, { data: { evaluationTemplatePut } }) => {
                    ...
                    data.accountGet.evaluationTemplates.unshift(evaluationTemplatePut)
                  }
                })
              ...
              templates.map((template, i) => (
                ...
                >
                  ...
                  <div
                    ...
                    <Link
                      to={`${evaluation_template}/${template.id}`}
                      >
                          ...
                          onClick={() => {
                            ...
                            mutate({
                              ...
                              update: (proxy) => {
                                ...
                                data.accountGet.evaluationTemplates.filter(t => t.id !== template.id)
                              }
                            })
                          }}
                          >
