    ...
    const FunnelPopup = ({ no }) => (
        <div className={styles.funnelPopup}>
            ...
            <ul onClick={() => setFunnel(false)}>
                <li> <img src={Red} /> Reviewed</li>
                <li> <img src={Red} /> Analyzed</li>
                <li> <img src={Green} /> Met</li>
            </ul>
        </div>
    )
                ...
                <table className={styles.startupTable}>
                    <thead>
                        <tr>
                            ...
                            <td className={styles.tdCompany}><p>COMPANY NAME</p></td>
                            {fields.group && <td className={styles.tdGroup}><p>GROUPS</p></td>}
                            {fields.funnel && <td className={styles.tdFunnel}><p>FUNNEL STAGE</p></td>}
                            {fields.tag && <td className={styles.tdTags}><p>TAGS</p></td>}
                            {fields.score && <td className={styles.tdSubjective}><p>SUBJECTIVE <br /> SCORE</p></td>}
                            {fields.updated && <td className={styles.tdUpdate}><p>UPDATED</p></td>}
                            {fields.evaluation && <td className={styles.tdEvaluation}><p>LAST <br /> EVALUATION</p></td>}
                            {fields.pitching && <td className={styles.tdPitching}><p>AFTER  <br /> PITCHING</p></td>}
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td>
                                <label className={styles.customCheck}>
                                    <input type="checkbox" onChange={() => handleCheckChange(0)} />
                                    <span class={styles.checkmark}></span>
                                </label>
                            ...
                            <td className={styles.tdCompany} onMouseOver={() => showPreview(0)} onMouseLeave={hidePreview}> <img src={Imag} /> Great Startup Inc
                            {
                                    preview === 0 && <StartupPreview no={0} />
                                }
                            </td>
                            {fields.group && <td className={styles.tdGroup}>Group1, Big Group 2 <ButtonGreen type="group" /> </td>}
                            {fields.funnel && <td className={styles.tdFunnel}>
                                <div className={styles.startupStatus}>
                                    <img src={Red} /> Reviewed <span onClick={() => setFunnel(0)}><i class="fas fa-chevron-down"></i></span>
                                    {
                                        funnel === 0 && <FunnelPopup />
                                    }
                                </div>
                            </td>}
                            {fields.tag && <td className={styles.tdTags}>
                                <ul>
                                    <li><span>MedTech</span></li>
                                    <li><span>OceanTech</span> ...</li>
                                    <li><ButtonGreen type="tags" /></li>
                                </ul>
                            </td>}
                            {fields.score && <td className={styles.tdSubjective}><ButtonGreen type="score" /></td>}
                            {fields.updated && <td className={styles.tdUpdate}><span className={styles.olderThan}>Older than 2 month</span></td>}
                            {fields.evaluation && <td className={styles.tdEvaluation}>65% <span> <i className="fas fa-pen"></i></span></td>}
                            {fields.pitching && <td className={styles.tdPitching}>65% <span> <i className="fas fa-pen"></i></span></td>}
                        </tr>
                        ...
                        <tr>
                            <td>
                                <label className={styles.customCheck}>
                                    <input type="checkbox" onChange={()=> handleCheckChange(1)} />
                                    <span class={styles.checkmark}></span>
                                </label>
                                <div className={styles.favStartup}> <i class="fas fa-star"></i></div>
                                {
                            ...
                            <td className={styles.tdCompany} onMouseOver={() => showPreview(1)} onMouseLeave={hidePreview}> <img src={Imag} /> Great Startup Inc
                            {
                                    preview === 1 && <StartupPreview no={1} />
                                }
                            </td>
                            {fields.group && <td className={styles.tdGroup}>Group1, Big Group 2 <ButtonGreen /> </td>}
                            {fields.funnel && <td className={styles.tdFunnel}>
                                <div className={styles.startupStatus}>
                            ...
                            {fields.score && <td className={styles.tdSubjective}>8,5 <span> <i className="fas fa-pen"></i></span></td>}
                            {fields.updated && <td className={styles.tdUpdated}>Jan 25, 2020</td>}
                            {fields.evaluation && <td className={styles.tdEvaluation}><ButtonGreen type="score" /></td>}
                            {fields.pitching && <td className={styles.tdPitching}>65% <span> <i className="fas fa-pen"></i></span></td>}
                        </tr>
                    </tbody>
                </table>
