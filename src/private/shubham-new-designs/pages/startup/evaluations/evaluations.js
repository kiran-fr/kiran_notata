      ...
      <div className="col-sm-12">
        <div className="card evaluation-container">
          <div className="row">
            ...
            <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12 evalations-container">
              <div className="row heading-icon">
                <div className="col-sm-1 col-xs-1 name-icon">G</div>
                <div className="col-sm-10 col-xs-8 evalations-container__heading">
                  Great Startup Inc
                  <span className="material-icons">star</span>
                </div>
              </div>
              <div className="row evalations-container__details">
                <div className="col-sm-6 col-xs-9 eval-score-heading">
                  Avarage subjective score
                </div>
              ...
              <div className={`col-sm-12 details`}>
                ...
                <div className={myTeamEvalState}>
                  ...
                  >
                    <div className="row">
                      <div className="col-sm-10 col-xs-8 submitions">
                        Daria Kyselova <span className="you">(you)</span>
                      </div>
                      <div className="col-sm-2 col-xs-4 score score-submisisons">
                        75%{" "}
                        <span
                          className="full-list"
              ...
              <div className={`col-sm-12 details`}>
                <div className="heading">
                  <i
                    ...
                    aria-hidden="true"
                    onClick={() =>
                      setGroupEvalState(groupEvalState === "" ? "collapse" : "")
                    }
                  ></i>
                  Groups evaluations
                </div>
